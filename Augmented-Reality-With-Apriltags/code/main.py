...
if __name__ == "__main__":
    ...
    parser.add_argument('--solver', type=str, default='PnP', help="Algorithm to use, PnP or P3P",
                        choices=["PnP", "P3P"])
    ...
    if args.click_points:
        ...
        frame = imageio.imread("HW2_coding/data/frames/frame0000.jpg")
    ...
    frames = glob.glob('HW2_coding/data/frames/*.jpg')
    frames.sort()
    images = [np.array(imageio.imread(f)) for f in frames]

    # extrinsic
    corners = np.load('HW2_coding/data/corners.npy')
    ...
    drill_mesh = trimesh.load("HW2_coding/data/models/drill.obj")
    fuze_mesh = trimesh.load("HW2_coding/data/models/fuze.obj")
