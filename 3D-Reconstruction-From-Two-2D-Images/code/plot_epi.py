...
def plot_epipolar_lines(image1, image2, uncalibrated_1, uncalibrated_2, E, K, plot=True):
    ...
    inputs:
    - image1: HxWx3 Matrix, First Image (Left)
    - image2: HxWx3 Matrix, Second Image (Right)
    - uncalibrated_1: Nx3 Matrix, Uncalibrated Points from Image1 (Homogeneous Coordinates)
    - uncalibrated_2: Nx3 Matrix, Uncalibrated Points from Image2 (Homogeneous Coordinates)
    - E: 3x3 Matrix, Essential Matrix
    - K: 3x3 Matrix, Intrinsic Camera Matrix
